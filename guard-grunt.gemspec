...
Gem::Specification.new do |spec|
  ...
  spec.summary       = 'guard gem for grunt'
  spec.description   = 'Guard::Grunt automatically starts/stops/restarts grunt'
  spec.homepage      = 'https://github.com/ggrocco/guard-grunt'
  spec.license       = 'MIT'
